...
//+kubebuilder:rbac:groups=routing.lf-net.org,resources=peers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=routing.lf-net.org,resources=peers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=routing.lf-net.org,resources=peers/finalizers,verbs=update
